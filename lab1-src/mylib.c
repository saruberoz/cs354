...
int scanf(char * s, int a1, int a2, int a3, int a4, int a5) {
  return (FUNC_TABLE[1])(s, a1, a2, a3, a4, a5);
}

char gets(char *s) {
  return (char) (FUNC_TABLE[2] (s));
}

char puts(char *s) {
  return (char) (FUNC_TABLE[3] (s));
}

int putchar(int a) {
  return (FUNC_TABLE[4] (a));
}

int strlen(char *s) {
  return (FUNC_TABLE[5] (s));
}

char *strcpy(char *s1, const char *s2) {
  return (char *)(FUNC_TABLE[6] (s1, s2));
}